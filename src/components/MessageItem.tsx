    ...
    <div class="py-2 -mx-4 px-4 transition-colors md:hover:bg-slate/3">
      ...
      { (showRetry&&showRetry()) && onRetry && (
        <div class="flex items-center justify-end px-3 mb-2">
          <div onClick={onRetry} class="flex items-center gap-1 px-2 py-0.5 op-70 border border-slate text-black rounded-md text-sm cursor-pointer hover:bg-slate/10">
            <IconRefresh />
